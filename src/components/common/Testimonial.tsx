...
//    <section className=" py-1 md:py-6 px-1 max-w-[clamp(320px,85%,2000px)] mx-auto relative">
//   {/* Slider */}
...
//           <h3 className="text-[clamp(0.75rem,2vw,1rem)] font-thin mb-2 md:mb-8">People Are Talking</h3>
//           {/* ⭐ Ratings */}
...
//       ))}
//     </div>
//           <p className="text-[clamp(0.75rem,2vw,1.5rem)] font-thin break-words mb-2 md:mb-6">“{t.quote}”</p>
...
//   className="abosolute -left-6 md:-left-14 top-1/2 -translate-y-1/2 z-10"
// >
