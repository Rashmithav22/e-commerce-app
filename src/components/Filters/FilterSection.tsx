...
//   // 👇 Local state for "View More / View Less"
//   const [showAllCategories, setShowAllCategories] = useState(false);

//   // 👇 If collapsed, only show first 4 categories
...
//               className="mt-2 text-sm font-medium text-blue-600 self-start hover:underline"
//             >
